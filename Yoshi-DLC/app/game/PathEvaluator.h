...
namespace app
{
    namespace game
    {
        ...
        public:
            ...
            inline static FUNCTION_PTR(int*, __thiscall, GetPNT, ASLR(0x004D8E50), PathEvaluator* This, int* a2, csl::math::Vector3* a3, csl::math::Vector3* a4, csl::math::Vector3* a5);
        };
    }
}