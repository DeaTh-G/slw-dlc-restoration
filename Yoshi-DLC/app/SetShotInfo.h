...
namespace app
{
    inline static void SetShotInfo(float speed, float distance, float outOfControl, csl::math::Matrix34* transformMatrix, bool jumpBoardType, app::game::GOCLauncher::ShotInfo* shotInfo)
    {
