...
namespace app
{
    ...
    public:
        ...
        inline static FUNCTION_PTR(fnd::HFrame*, __thiscall, GetCenterPositionFrame, ASLR(0x00672080), EnemyBase* This);
        inline static FUNCTION_PTR(int*, __thiscall, SendTouchDamage, ASLR(0x00672180), EnemyBase* This, xgame::MsgDamage& message);
