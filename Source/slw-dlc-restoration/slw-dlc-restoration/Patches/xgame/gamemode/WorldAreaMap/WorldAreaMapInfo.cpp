...
HOOK(void, __fastcall, LoadHook, ASLR(0x00948520), app::WorldAreaMapInfo* in_pThis, void* edx, app::CObjInfoFileLoader& in_rLoader)
{
...
void slw_dlc_restoration::WorldAreaMapInfo::InstallHooks()
{
